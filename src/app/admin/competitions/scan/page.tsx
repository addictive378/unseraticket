...
import { ScanLine, CheckCircle2, XCircle, AlertTriangle, RotateCcw, Camera, CameraOff, Trophy } from 'lucide-react';

export default function ScanCompetitionRegistrationPage() {
    ...
    return (
        <div>
            <div className={styles.pageHeader}>
                <div>
                    <h1>Scan Peserta Kompetisi</h1>
                    <p>Scan QR code peserta untuk verifikasi pendaftaran dan kehadiran.</p>
                </div>
            </div>
            ...
            <div style={{ maxWidth: '600px', margin: '2rem auto' }}>
                    ...
                    <div className="glass" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                        ...
                        {!scanning && (
                            <div style={{ padding: '3rem', textAlign: 'center' }}>
                                <Trophy size={56} style={{ color: 'var(--primary)', marginBottom: '1.5rem' }} />
                                <h3 style={{ marginBottom: '0.75rem' }}>Competition QR Scanner</h3>
                                <p style={{ color: 'rgba(255,255,255,0.5)', marginBottom: '2rem', fontSize: '0.9rem' }}>
                                    Arahkan kamera ke QR code peserta (ELVIN-COMP:xxx)
                                </p>
                ...
                {processing && (
                    <div className="glass" style={{ borderRadius: '20px', padding: '3rem', textAlign: 'center', marginTop: '1.5rem' }}>
                        <div className={styles.loading}>Memverifikasi peserta...</div>
                    </div>
                )}
                    ...
                    <div className="glass" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                        ...
                        <div style={{
                            ...
                            <h2 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>
                                {scanResult.valid ? '✅ Peserta Terdaftar' : '❌ Verifikasi Gagal'}
                            </h2>
                        ...
                        {scanResult.registration && (
                            <div style={{ padding: '1.5rem' }}>
                                <div style={{ display: 'grid', gap: '1rem' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.75rem 0', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                                        <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem' }}>Nama Peserta</span>
                                        <span style={{ fontWeight: 600 }}>{scanResult.registration.buyerName}</span>
                                    </div>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.75rem 0', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                                        <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem' }}>Kompetisi</span>
                                        <span style={{ fontWeight: 600 }}>{scanResult.registration.competitionName}</span>
                                    </div>
                                    {scanResult.registration.status && (
                                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.75rem 0' }}>
                                            <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem' }}>Status Registrasi</span>
